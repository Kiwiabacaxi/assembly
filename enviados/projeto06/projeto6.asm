...
; O programa inicia com valor “000,0” no display e permanece assim até que o botão RB0 seja pressionado. Neste instante inicia a contagem no modo crescente. O intervalo é de 0,1s.
; Se o contador chegar ao 999,9, ele deve reiniciar e continuar a contar.
; O botão RB1 para a contagem no valor que estiver.
; O contador pode ser novamente acionado, a partir do número que está, através do botão RB0.
; O botão RB2 zera o contador, porém, só é possível zerá-lo se a contagem estiver parada.
; O intervalo de varredura dos displays é de 4ms, ou seja, cada display fica aceso a cada 1ms.
; Use clock de 8MHz.
