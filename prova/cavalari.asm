...
START
    ...
    BCF     INTCON,T0IE             ; Habilita interrupção por Timer0
    BSF     INTCON,GIE              ; Habilita interrupções globais

    GOTO    LACO_PRINCIPAL          ; Loop principal

LACO_PRINCIPAL
    ;CALL   ATUALIZA_DISPLAY         ; Exibe valor atualizado no display (pode ser ativado)
...
MUDAR_CONTATOR
    MOVLW   .183                    ; Carrega o valor 183 em W (timer calculado)
